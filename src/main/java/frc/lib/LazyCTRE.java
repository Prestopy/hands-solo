 ...
 */
public interface LazyCTRE<T, S> extends LazyMotor<T> {
    /**
     ...
     */
    public LazyCTRE<T, S> withFollower(int followerID, MotorAlignmentValue isInverted);
    ...
    public LazyCTRE<T, S> withCANCoder(int CANCoderID, S sensorType, double magnetOffset, SensorDirectionValue sensorDirection, double discontinuityPoint, double rotorToSensorRatio);
     ...
     /**
     * Configures the motion magic parameters for this motor's motion profiling
     *
    ...
    public LazyCTRE<T, S> withMotionMagicConfiguration(double p, double i, double d, double s, double g, double v, double a, double expoV, double expoA, GravityTypeValue gravityType, double cruiseVelocity, double maxAcceleration);
     ...
     /**
     * Configures the motion magic parameters for this motor's motion profiling with the given slot
     *
     * @param p the proportional gain
     * @param i the integral gain
     * @param d the derivative gain
     ...
     * @return this motor instance for method chaining
     */
    public LazyCTRE<T, S> withMotionMagicConfiguration(double p, double i, double d, double s, double g, double v, double a, double expoV, double expoA, GravityTypeValue gravityType, double cruiseVelocity, double maxAcceleration, int slot);
    ...
    public static class StatusSignalMotorTelemetry {
